...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void _register() async {
    ...
    if (passwordController.text == confirmPasswordController.text) {
      try{
        authService.register(emailController.text, passwordController.text).then((_){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => HomePage()));
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Register Berhasil"), backgroundColor: Colors.green,));
        });
      }catch(e){
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Register gagal ${e.toString()}"), backgroundColor: Colors.red,));
      }
    }else{
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Password tidak sama dengan Confirm Password"), backgroundColor: Colors.red,));
    }
    }else{
        ...
        children: [
          ...
          Padding(
            ...
            child: TextFormField(
              ...
              textInputAction: TextInputAction.next,
              decoration: InputDecoration(
                  hintText: "Massukka Password anda",
                  labelText: "Password",
                  floatingLabelBehavior: FloatingLabelBehavior.always,
                  hintStyle: const TextStyle(color: Color(0xFF757575)),
                  contentPadding: const EdgeInsets.symmetric(
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
                hintText: "Massukka Password anda",
                labelText: "Massukka kembali Password anda",
                floatingLabelBehavior: FloatingLabelBehavior.always,
                hintStyle: const TextStyle(color: Color(0xFF757575)),
                contentPadding: const EdgeInsets.symmetric(
                  horizontal: 24,
